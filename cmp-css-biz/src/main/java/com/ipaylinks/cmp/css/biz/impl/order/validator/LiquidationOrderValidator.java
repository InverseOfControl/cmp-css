 ...
 */
@Service
public class LiquidationOrderValidator extends AbstractProcessor {
    ...
    protected void doProcess(Context ctx) throws Exception {
        logger.debug("LiquidationOrderValidator begin");
        logger.debug("LiquidationOrderValidator end");
    }
}
